...
// hack      resultMetadata.setOptionalData(Arrays.copyOf(additionalOptionCodeWords, additionalOptionCodeWordsIndex));
...
// hack    result.append(new String(decodedBytes.toByteArray(), encoding));
    return codeIndex;
  }
