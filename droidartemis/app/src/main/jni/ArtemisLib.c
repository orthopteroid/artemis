...
JNIEXPORT void JNICALL Java_com_tereslogica_arcanacard_ArtemisLib_nativeInit(JNIEnv * env, jobject obj)
{
    library_init();
    rc = 0;
}

JNIEXPORT void JNICALL Java_com_tereslogica_arcanacard_ArtemisLib_nativeCleanup(JNIEnv * env, jobject obj)
{
    library_cleanup();
}
